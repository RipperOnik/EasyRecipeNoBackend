...
function Appetizers() {
    ...
    dispatch((0, reducerActions_1.navigateTab)(strings_1.TabItemsNames.APPETIZERS));
    dispatch((0, reducerActions_1.navigateToFeed)({ useQuery: function () { return api_1.useGetAppetizersPostsQuery; }, header: strings_1.TabItemsNames.APPETIZERS, tag: "" }));
    return (react_1.default.createElement(CardGroup_1.default, null));
}
exports.default = Appetizers;
//# sourceMappingURL=Appetizers.js.map