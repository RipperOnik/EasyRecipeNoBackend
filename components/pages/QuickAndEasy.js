...
function QuickAndEasy() {
    ...
    dispatch((0, reducerActions_1.navigateTab)(strings_1.TabItemsNames.QUICKANDEASY));
    dispatch((0, reducerActions_1.navigateToFeed)({ useQuery: function () { return api_1.useGetEasyPostsQuery; }, header: strings_1.TabItemsNames.QUICKANDEASY, tag: "" }));
    return (react_1.default.createElement(CardGroup_1.default, null));
}
exports.default = QuickAndEasy;
//# sourceMappingURL=QuickAndEasy.js.map