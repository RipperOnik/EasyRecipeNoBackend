...
function Salads() {
    ...
    dispatch((0, reducerActions_1.navigateTab)(strings_1.TabItemsNames.SALADS));
    dispatch((0, reducerActions_1.navigateToFeed)({ useQuery: function () { return api_1.useGetSaladsPostsQuery; }, header: strings_1.TabItemsNames.SALADS, tag: "" }));
    return (react_1.default.createElement(CardGroup_1.default, null));
}
exports.default = Salads;
//# sourceMappingURL=Salads.js.map