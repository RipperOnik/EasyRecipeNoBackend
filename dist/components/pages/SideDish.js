...
function SideDish() {
    ...
    dispatch((0, reducerActions_1.navigateTab)(strings_1.TabItemsNames.SIDEDISH));
    dispatch((0, reducerActions_1.navigateToFeed)({ useQuery: function () { return api_1.useGetSideDishPostsQuery; }, header: strings_1.TabItemsNames.SIDEDISH, tag: "" }));
    return (react_1.default.createElement(CardGroup_1.default, null));
}
exports.default = SideDish;
//# sourceMappingURL=SideDish.js.map