...
const Layout = () => {
  ...
  useEffect(() => {
    if (pathname === "/dishes/brownie") {
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.brownie.name,
          tag: Dishes.brownie.tag,
        })
      );
      ...
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.burger.name,
          tag: Dishes.burger.tag,
        })
      );
      ...
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.cookie.name,
          tag: Dishes.cookie.tag,
        })
      );
      ...
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.lasagna.name,
          tag: Dishes.lasagna.tag,
        })
      );
      ...
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.pancake.name,
          tag: Dishes.pancake.tag,
        })
      );
      ...
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.pizza.name,
          tag: Dishes.pizza.tag,
        })
      );
      ...
      dispatch(
        navigateToFeed({
          useQuery: () => useGetCertainDishPostsQuery,
          header: Dishes.sandwich.name,
          tag: Dishes.sandwich.tag,
        })
      );
