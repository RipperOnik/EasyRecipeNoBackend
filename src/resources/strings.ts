...
import Dish from "../components/interfaces/Dish";
...
export const Dishes = {
  ...
  cookie: {
    name: "Cookie",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-cookie)",
  },
  pie: {
    name: "Pie",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-pie)",
  },
  sandwich: {
    name: "Sandwich",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-sandwich)",
  },
  pizza: {
    name: "Pizza",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-pizza)",
  },
  burger: {
    name: "Burger",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-burger)",
  },
  pancake: {
    name: "Pancake",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-pancake)",
  },
  brownie: {
    name: "Brownie",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-brownie)",
  },
  lasagna: {
    name: "Lasagna",
    tag: "list.recipe.search_based:fq:attribute_s_mv:(dish\\^dish\\-lasagna)",
  },
};
